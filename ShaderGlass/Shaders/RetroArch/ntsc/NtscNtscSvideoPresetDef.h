/*
ShaderGlass preset ntsc / ntsc-svideo imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/master/ntsc/ntsc-svideo.slangp
...
namespace RetroArch
{
class NtscNtscSvideoPresetDef : public PresetDef
{
public:
	NtscNtscSvideoPresetDef() : PresetDef{}
	{
		Name = "ntsc-svideo";
		Category = "ntsc";
	}
