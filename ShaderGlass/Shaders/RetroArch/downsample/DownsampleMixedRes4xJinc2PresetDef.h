/*
ShaderGlass preset downsample / mixed-res-4x-jinc2 imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/23046258f7fd02242cc6dd4c08c997a8ddb84935/downsample/mixed-res-4x-jinc2.slangp
...
namespace RetroArch
{
class DownsampleMixedRes4xJinc2PresetDef : public PresetDef
{
public:
	DownsampleMixedRes4xJinc2PresetDef() : PresetDef{}
	{
		Name = "mixed-res-4x-jinc2";
		Category = "downsample";
	}
