/*
ShaderGlass preset presets / scalefx+rAA+aa imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/6f921ee4815a7894a33855974285b04545a4fa42/presets/scalefx+rAA+aa.slangp
...
namespace RetroArch
{
class PresetsScalefxRAAAaPresetDef : public PresetDef
{
public:
	PresetsScalefxRAAAaPresetDef() : PresetDef{}
	{
		Name = "scalefx+rAA+aa";
		Category = "presets";
	}
