/*
ShaderGlass preset presets / crt-guest-dr-venom-ntsc-composite-stock imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/master/presets/crt-guest-dr-venom-ntsc-composite-stock.slangp
...
namespace RetroArch
{
class PresetsCrtGuestDrVenomNtscCompositeStockPresetDef : public PresetDef
{
public:
	PresetsCrtGuestDrVenomNtscCompositeStockPresetDef() : PresetDef{}
	{
		Name = "crt-guest-dr-venom-ntsc-composite-stock";
		Category = "presets";
	}
