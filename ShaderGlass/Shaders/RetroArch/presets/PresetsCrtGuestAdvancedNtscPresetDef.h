/*
ShaderGlass preset presets / crt-guest-advanced-ntsc imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/master/presets/crt-guest-advanced-ntsc.slangp
...
namespace RetroArch
{
class PresetsCrtGuestAdvancedNtscPresetDef : public PresetDef
{
public:
	PresetsCrtGuestAdvancedNtscPresetDef() : PresetDef{}
	{
...
.Param("scale_x", "1.0")
.Param("scale_y", "1.0"));
         	ShaderDefs.push_back(CrtShadersGuestAdvancedConvertNtscShaderDef()
.Param("filter_linear", "true")
.Param("scale_type", "source")
.Param("scale_x", "0.5")
.Param("scale_y", "1.0"));
...
.Param("scale_x", "640.0")
.Param("scale_y", "480.0"));
         	ShaderDefs.push_back(CrtShadersGuestAdvancedCrtGuestAdvancedNtscShaderDef()
.Param("filter_linear", "true")
