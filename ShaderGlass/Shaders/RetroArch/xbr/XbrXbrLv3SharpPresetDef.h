/*
ShaderGlass preset xbr / xbr-lv3-sharp imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/6f921ee4815a7894a33855974285b04545a4fa42/xbr/xbr-lv3-sharp.slangp
...
namespace RetroArch
{
class XbrXbrLv3SharpPresetDef : public PresetDef
{
public:
	XbrXbrLv3SharpPresetDef() : PresetDef{}
	{
		Name = "xbr-lv3-sharp";
		Category = "xbr";
	}
