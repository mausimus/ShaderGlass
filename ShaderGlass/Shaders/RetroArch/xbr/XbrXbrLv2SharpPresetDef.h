/*
ShaderGlass preset xbr / xbr-lv2-sharp imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/6f921ee4815a7894a33855974285b04545a4fa42/xbr/xbr-lv2-sharp.slangp
...
namespace RetroArch
{
class XbrXbrLv2SharpPresetDef : public PresetDef
{
public:
	XbrXbrLv2SharpPresetDef() : PresetDef{}
	{
		Name = "xbr-lv2-sharp";
		Category = "xbr";
	}
